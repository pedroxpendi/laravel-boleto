...
class Sicredi extends AbstractRemessa implements RemessaContract
{
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        $this->add(48, 56, $boleto->getEmissaoPropria() ? Util::formatCnab('9', $boleto->getNossoNumero(), 9) : '         ');
        $this->add(57, 62, '');
        $this->add(63, 70, Carbon::now()->format('Ymd'));
        $this->add(71, 71, '');
        $this->add(72, 72, $boleto->getEmissaoPropria() ? 'N' : 'S');
        $this->add(73, 73, '');
        $this->add(74, 74, $boleto->getEmissaoPropria() ? 'B' : 'A');
        $this->add(75, 76, '');
        $this->add(77, 78, '');
        $this->add(79, 82, '');
